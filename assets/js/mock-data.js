...
var MockDB = {
  ...
  seed: function () {
    return {
      usuarios: [
        { codigo: "ADM-2027", nome: "ANA (CONEXÃO JUNINA)", perfil: "admin", eventos: ["evt-1"], ativo: true },
        { codigo: "PRES-2027", nome: "UBIRATAM", perfil: "presidente", eventos: ["evt-1"], ativo: true },
        { codigo: "AVAL-2027", nome: "HELENA BARBOSA", perfil: "avaliador", eventos: ["evt-1"], ativo: true },
        { codigo: "AVAL2-2027", nome: "TAYWAN RAMIRES", perfil: "avaliador", eventos: ["evt-1"], ativo: true },
        { codigo: "AVAL3-2027", nome: "GRACINHA", perfil: "avaliador", eventos: ["evt-1"], ativo: true },
        { codigo: "CONS-2027", nome: "CONSULTORIA CONEXÃO", perfil: "consultor", eventos: ["evt-1"], ativo: true }
      ],

      // Catálogo GLOBAL de quesitos. Cada evento usa os que forem
      // "válidos para todos" + os específicos que o incluam em `eventos`.
      quesitosGlobais: [
        { id: "q1", nome: "DESENVOLTURA", peso: 1, ordem: 1, validoParaTodos: true, eventos: [] },
        { id: "q2", nome: "CRIATIVIDADE", peso: 1, ordem: 2, validoParaTodos: true, eventos: [] },
        { id: "q3", nome: "SIMPATIA", peso: 1, ordem: 3, validoParaTodos: true, eventos: [] },
        { id: "q4", nome: "ATUAÇÃO", peso: 1, ordem: 4, validoParaTodos: true, eventos: [] }
      ],

      // Catálogo GLOBAL de grupos/quadrilhas. Cada evento associa um
      // subconjunto deles (ver evento.candidatas, que referencia estes IDs).
      gruposCandidatas: [
        { id: "c1", nome: "QUADRILHA ESTRELA DO NORTE", cidade: "FORTALEZA", estado: "CE" },
        { id: "c2", nome: "ARRAIÁ DO VALE", cidade: "CARUARU", estado: "PE" },
        { id: "c3", nome: "SANFONA DE OURO", cidade: "FEIRA DE SANTANA", estado: "BA" },
        { id: "c4", nome: "JUNINA ENCANTO", cidade: "JUAZEIRO DO NORTE", estado: "CE" },
        { id: "c5", nome: "FORRÓ DO SERTÃO", cidade: "MOSSORÓ", estado: "RN" }
      ],
